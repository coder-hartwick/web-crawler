...
public class Controller {
     ...
     * @param start         The button to disable if setup is complete and the
     *                      crawling starts.
     * @param stop          The button to enable when crawling starts so the
     *                      user can stop the crawling.
     */
    public void setupWebCrawler(JTextArea quickInfo, JButton start, JButton stop) {
        ...
        if(data[0] != null) {
            ...
            // Start web crawling on a new thread.
